 ...
 */
@Module({
  controllers: [TestController], // controoler 등록은 여기서만, 하위 module에서 따로 등록하면 route가 해당 모듈기준으로 추가로 생김
  imports: [SampleModule, SharedModule], // 서비스, 유즈케이스 등 도메인 로직은 여전히 이쪽에서 가져옴
})
